<template>
    <div>
      ...
      <div class="contenedorSB">
        <div class="textoRetiro">
          <h3>Podés retirar tu compra en nuestra sucursal en el momento que prefieras. Antes de concretar la compra en la página web de Quickmart.com, consulte nuestras políticas de retiro en sucursal.</h3>
          <br>
          <p>Horarios de Retiro en Sucursal: De Lunes a Sábado de 10 a 12hs y de 18 a 20 hs.</p>
        </div>
      </div>
      <br>
      <div class="iconoRetiro">
      ...
      <div class="contenedorSB">
        <div class="textoRetiro">
          <p>Ante cualquier cambio o devolución que desee realizar de algún producto, por favor póngase en contacto con nosotros al teléfono siguiente: 0800-1054-956. Para que tengas en cuenta, te informamos que los productos no perecederos podrán cambiarse o devolverse en un plazo de 30 días. En el caso de que haya un saldo a favor del comprador, lo contemplaremos en su próxima compra. Este saldo a favor tendrá vigencia durante 90 días desde su gestión.</p>
        </div>
      </div>
    </div>
    </div>
  ...
  <script>
  export default {
    name: 'cambios',  // Definimos un nombre para el componente
    mounted() {
      console.log('Cambios montados.');
  }}
  </script>
<style>
.retiro{
