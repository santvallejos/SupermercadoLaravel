...
/*toda la seccion del box de preguntas*/
.accordion {
  width: 800px;
  margin: 90px auto;
  color: black;
...
.accordion .containerPF.active .content {
  max-height: 150px;
 }

.accordion .containerPF.active .labelP::before {
  content: '-';
  font-size: 30px;
}
...
#back-to-top {
  ...
  background-color: #F2EEE4; /* Color de fondo */
