...
.containerCategorias {
    width: 100%;
    overflow-x: hidden;
    /* Deshabilita la barra de desplazamiento horizontal */
}

.carruselCategorias {
    display: flex;
    white-space: nowrap;
    /* Asegura que los elementos estén en una línea */
    width: 100%;
...
.item {
    flex: 0 0 auto;
    /* Evita que los elementos cambien de tamaño */
    width: calc(100% / 7);
    /* Ajusta el ancho de los elementos según el número de categorías */
    max-width: calc(100% / 7);
    /* Establece un ancho máximo para los elementos */
}
