...
@section('content')
    <section class="carrusel">
      ...
      <section class="bentoGrid">
        <div class="bentoColumnaIzquierda">
          <div class="filaBento filaBento1"></div>
          <div class="filaBento filaBento2"></div>
          <div class="filaBento filaBento3">
            <div class="filaColumna izquierda"></div>
            <div class="filaColumna derecha"></div>
          </div>
        </div>
        <div class="bentoColumnaDerecha">
          <div class="filaBento arriba"></div>
          <div class="filaBento abajo"></div>
        </div>
      </section>
