...
<body class="hold-transition sidebar-mini">
  <!-- Main Sidebar Container -->
    ...
    <a class="nav-link float-right" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <ul class="nav nav-pills nav-fill">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="{{ route('user.index') }}">List User</a>
      </li>
    </ul>
