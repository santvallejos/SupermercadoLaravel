...
<body>
    ...
    <header>
        ...
        <div>
            ...
            <a href="{{ url('/') }}"><img src="{{ asset('img/2.png') }}" alt=""
                    class="logoMovilHeader"></a>
        </div>
                ...
                @auth
                    ...
                    @if (auth()->check() && auth()->user()->roles[0]->id != 1)
                        <div class="contenidoUserLogueado" style="display: block; teex-align:center">
                            <img src="https://i.postimg.cc/sgVHzPTc/avatar-admin-removebg-preview.png" alt="avataradmin"
                                width="30" height="30">
                        </div>
                        <span> {{ Auth::user()->name }} </span>
                        <p>|</p>
                    ...
                    @else
                        ...
                        @if (Auth::user()->userdata->sexo == 'Masculino')
                            <div class="contenidoUserLogueado" style="display: block; teex-align:center">
                                <img src="https://i.postimg.cc/YS2r72DN/nino.png" alt="avatarniño" width="30"
                                    height="30">
                            </div>
                            <span> {{ Auth::user()->name }} </span>
                            <p>|</p>
                    ...
                    @else
                        <div class="contenidoUserLogueado" style="display: block; teex-align:center">
                            <img src="https://i.postimg.cc/Wpx1Zvtj/nina.png" alt="avatarniña" width="30"
                                height="30">
                        </div>
                        <span> {{ Auth::user()->name }} </span>
                        <p>|</p>
    ...
    {{-- Carrito de compras --}}
    <div>
        <a href="{{ route('checkout') }}" class="carritoCompras"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            </svg> <span class="carritoCount">{{ \Cart::count() }}</span></a>
    </div>
</header>
            ...
            <div class="columnaMedia">
                ...
                <div class="formasPagoFooter">
                    ...
                    <div class="metodosPagoFooter">
                        ...
                        <svg id="Layer_1" height="50" viewBox="0 0 24 24" width="50"
